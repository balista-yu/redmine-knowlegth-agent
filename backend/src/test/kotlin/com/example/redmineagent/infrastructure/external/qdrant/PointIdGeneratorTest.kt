...
class PointIdGeneratorTest :
    FunSpec({
        test("同じ ticketId と chunkIndex と subIndex なら同一 UUID") {
        ...
        test("chunk から生成しても position が同じなら同じ UUID") {
            val chunk =
                TicketChunk(
                    ticketId = 42,
        ...
        test("生成された UUID は version 5 で variant=RFC4122") {
